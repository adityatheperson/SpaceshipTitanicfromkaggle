...
# Average CV score on the training set was: 0.8005475073571624
exported_pipeline = make_pipeline(
    ...
    XGBClassifier(learning_rate=0.01, max_depth=7, min_child_weight=19, n_estimators=100, n_jobs=1, subsample=0.1, verbosity=0)
)
